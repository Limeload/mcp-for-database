          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto">
                Discover how our revolutionary natural language database interface transforms the way you interact with your data.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 md:p-12 border border-gray-100 dark:border-gray-700">
              ...
              <div className="space-y-6 text-gray-600 dark:text-gray-300">
                <p className="text-lg leading-relaxed">
                  <strong>MCP Database Console</strong> is a cutting-edge web application that transforms natural language into powerful database queries. Built with Next.js and powered by the MCP-DB Connector, it democratizes database access by allowing users to interact with databases using plain English instead of complex SQL syntax.
                </p>
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-xl border-l-4 border-blue-500">
                  ...
                  <ul className="space-y-2">
                    <li><strong>SQL Complexity:</strong> Writing SQL queries requires technical expertise and knowledge of database schemas</li>
                    <li><strong>Accessibility:</strong> Non-technical users struggle to extract insights from databases</li>
                    <li><strong>Time Consumption:</strong> Developers spend significant time writing and debugging SQL queries</li>
                    <li><strong>Learning Curve:</strong> New team members need time to understand database structures</li>
                  </ul>
                </div>
                ...
                <div className="bg-green-50 dark:bg-green-900/20 p-6 rounded-xl border-l-4 border-green-500">
                  ...
                  <p>Transform natural language into powerful database queries through an intuitive web interface that:</p>
                  <ul className="space-y-2 mt-3">
                    <li><strong>Understands Context:</strong> Interprets user intent from conversational prompts</li>
                    <li><strong>Supports Multiple Databases:</strong> Works with SQLAlchemy, Snowflake, and SQLite databases</li>
                    <li><strong>Provides Real-time Results:</strong> Shows query results instantly in formatted tables</li>
                    <li><strong>Handles Errors Gracefully:</strong> Offers helpful error messages and suggestions</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <section className="mb-16">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300">
                Transform your data interaction experience with these powerful advantages
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-700">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Enable non-technical users to query databases using natural language, breaking down barriers between business users and data insights.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-700">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Reduce time spent on query writing and debugging. Get answers faster with intelligent natural language processing.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-700">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Minimize SQL syntax errors through natural language processing and intelligent query generation.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-700">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Allow team members to share insights without requiring SQL knowledge, fostering better data-driven decision making.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 p-8 rounded-2xl border border-blue-100 dark:border-blue-800">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-blue-900 dark:text-blue-300">Business Analysts</h3>
                </div>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 p-8 rounded-2xl border border-purple-100 dark:border-purple-800">
                <div className="flex items-center mb-4">
                  <div className="w-10 h-10 bg-purple-500 rounded-lg flex items-center justify-center mr-3">
                    <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14-7v16l-4-3.5-4 3.5V11a2 2 0 012-2h4zm-8 14v-2a3 3 0 013-3h3a3 3 0 013 3v2H7a2 2 0 00-2 2h8a2 2 0 002-2v-2z" />
                    </svg>
                  </div>
                  <h3 className="text-lg font-semibold text-purple-900 dark:text-purple-300">Product Managers</h3>
                </div>
              ...
              <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 p-8 rounded-2xl border border-green-100 dark:border-green-800">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-green-900 dark:text-green-300">Data Scientists</h3>
                </div>
              ...
              <div className="bg-gradient-to-br from-orange-50 to-red-50 dark:from-orange-900/20 dark:to-red-900/20 p-8 rounded-2xl border border-orange-100 dark:border-orange-800">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-orange-900 dark:text-orange-300">Operations Teams</h3>
                </div>
              ...
              <div className="bg-gradient-to-br from-indigo-50 to-blue-50 dark:from-indigo-900/20 dark:to-blue-900/20 p-8 rounded-2xl border border-indigo-100 dark:border-indigo-800">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-indigo-900 dark:text-indigo-300">Students & Researchers</h3>
                </div>
              ...
              <div className="bg-gradient-to-br from-pink-50 to-rose-50 dark:from-pink-900/20 dark:to-rose-900/20 p-8 rounded-2xl border border-pink-100 dark:border-pink-800">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-pink-900 dark:text-pink-300">IT Administrators</h3>
                </div>
          ...
          <section className="mb-16">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 md:p-12 border border-gray-100 dark:border-gray-700">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-6">Currently Supported</h3>
                  <div className="space-y-4">
                    <div className="flex items-center p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                      ...
                      <div>
                        <div className="font-semibold text-gray-900 dark:text-white">Snowflake</div>
                        <div className="text-sm text-gray-600 dark:text-gray-300">Cloud data warehouse for analytics</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                      ...
                      <div>
                        <div className="font-semibold text-gray-900 dark:text-white">SQLAlchemy</div>
                        <div className="text-sm text-gray-600 dark:text-gray-300">Python ORM for multiple databases</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center p-4 bg-slate-50 dark:bg-slate-100 rounded-lg">
                      ...
                      <div>
                        <div className="font-semibold text-gray-900 dark:text-white">SQLite</div>
                        <div className="text-sm text-gray-600 dark:text-gray-300">Lightweight file-based database</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-6">Coming Soon</h3>
                  <div className="space-y-4">
                    <div className="flex items-center p-4 bg-green-50 dark:bg-green-900/20 rounded-lg opacity-75">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-600 dark:text-gray-300">Advanced open-source relational database</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg opacity-75">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-600 dark:text-gray-300">Popular open-source database</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center p-4 bg-red-50 dark:bg-red-900/20 rounded-lg opacity-75">
                      ...
                      <div>
                        <div className="font-semibold text-gray-900 dark:text-white">Microsoft SQL Server</div>
                        <div className="text-sm text-gray-600 dark:text-gray-300">Enterprise relational database</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg opacity-75">
                      ...
                      <div>
                        <div className="font-semibold text-gray-900 dark:text-white">MongoDB</div>
                        <div className="text-sm text-gray-600 dark:text-gray-300">Leading NoSQL document database</div>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <section className="mb-16">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 md:p-12 border border-gray-100 dark:border-gray-700 text-gray-900 dark:text-white">
              ...
              <p className="text-xl mb-8 opacity-90">
                Experience the power of natural language database queries in just a few clicks.
              </p>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 md:p-12 border border-gray-100 dark:border-gray-700 text-gray-900 dark:text-white">
              <div className="text-center">
                ...
                <p className="text-xl mb-6 opacity-90">
                  Join the <a href="https://github.com/Limeload/mcp-for-database" target="_blank" rel="noopener noreferrer" className="underline hover:no-underline font-semibold">open-source community</a> and contribute to this amazing project!
                </p>
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 mb-8">
                  ...
                  <div className="grid md:grid-cols-3 gap-4 text-sm">
                    <div className="bg-white/10 rounded-lg p-4">
                      <div className="font-semibold mb-2">Good First Issues</div>
